...
implementation
  ...
  function GetApplicationCheckOutDir: string;
  begin
    Result := IncludeTrailingBackSlash(GetAppConfigDir(FALSE)) + ('checkout');
  end;
  
  function GetApplicationConfigDir: string;
  begin
    Result := IncludeTrailingBackSlash(GetAppConfigDir(FALSE)) + ('configuration');
  end;
  
  function GetApplicationTempDir: string;
  begin
    Result := IncludeTrailingBackSlash(GetAppConfigDir(FALSE)) + ('temp');
  end;
