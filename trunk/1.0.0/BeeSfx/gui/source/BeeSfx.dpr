...
type
  ...
  procedure TSFX.OnRename;    begin (* nothing to do *) end;
  procedure TSFX.OnList;      begin (* nothing to do *) end;
  procedure TSFX.OnClear;     begin (* nothing to do *) end;
  procedure TSFX.OnOverWrite; begin (* nothing to do *) end;
  procedure TSFX.OnWarning;   begin (* nothing to do *) end;
  ...
  begin
    ...
    begin
      ...
      while RETURN = FALSE do begin (* wait password... *) end;
    end;
...
var
  ...
  function PASSWORD_STEP (HW: hwnd; umsg: dword; wparam: wparam; lparam: lparam): bool; stdcall;
  begin
    PASSWORD_HW := HW;
    Result := True;
    case umsg of
      ...
      WM_COMMAND: if hiword (wparam) = BN_CLICKED then
                    case loword (wparam) of
                      ...
                      IDOK   : begin
                                 ...
                                 SetLength (KEY, GetDlgItemText (HW, 202, PChar (KEY), MAX_PATH));
                               end;
                    end;
      else Result := False;
    end;
                    ...
                    case loword (wparam) of
                      ...
                      IDOK   : if Sfx = nil then
                               begin
                                 ...
                                 SetLength (PATH, GetDlgItemText (HW, 104, PChar (PATH), MAX_PATH));
