...
begin
  ...
  SelfName := 'The Bee 0.7.9 build 0507 archiver utility, freeware version, Nov 2007.'
...
begin
  ...
  AppInterface.cMsg := ('    cfg<filename> use specified configuration file'); Synchronize(AppInterface.OnDisplay);
