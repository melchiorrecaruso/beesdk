...
6.5   Release 3.05 -Bug Fixes and Enhancements Beta #7 (Everyone should read this section!)
...
6.5   Release 3.05 -Bug Fixes and Enhancements Beta #7

 []   TAbTarArchive.FixName doesn't set the correct Item.FileName
 []   TAbTarArchive.SaveArchive doesn't show the process status
 []   TAbZipArchive.SaveArchive doesn't show the process status
 []   TAbGZArchive.SaveArchive doesn't show the process status
