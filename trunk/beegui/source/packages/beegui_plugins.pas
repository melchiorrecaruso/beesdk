  ...
  case FCommandLine.Command of
    ...
    begin
      Interfaces.OnError.Data.Msg :=
        SevenZipPluginVer + ' - error : command line unsupported';
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          ItemStr[14] := '.';
          try
            Interfaces.OnList.Data.FileTime :=
              DateTimeToFileDate(StrToDateTime(ItemStr));
          except
        ...
        begin
          ...
          begin
            if Pos('D', ItemStr) > 0 then
              FileAttr := FileAttr or faDirectory;
            ...
            if Pos('S', ItemStr) > 0 then
              FileAttr := FileAttr or faSysFile;
            if Pos('A', ItemStr) > 0 then
              FileAttr := FileAttr or faArchive;
          end;
        end
        else
        // File Password
