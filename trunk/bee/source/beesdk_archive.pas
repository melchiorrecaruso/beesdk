...
function TArchiver.ReadCentralDirectory(aStream: TFileReader): boolean;
var
  Marker: longword;
...
procedure TArchiveWriter.OpenSwap;
var
  I: longint;
  CRC: longword;
  Item: TArchiveItem;
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          case Item.FTag of
            aitUpdate:          FArchiveItems.Delete(I);
            aitDecodeAndUpdate: FArchiveItems.Delete(I);
          end;
        end;
