...
type
  ...
  public
    ...
    property IsPresetDictionaryPresent: boolean Read GetIsPresetDictionaryPresent;
    property CompressionLevel: byte Read GetCompressionLevel Write SetCompressionLevel;
    property CompressionInfo: byte Read GetCompressionInfo Write SetCompressionInfo;

    property CompressionMethod: byte Read GetCompressionMethod
      Write SetCompressionMethod;
    property Adler32: longint Read FAdler32 Write FAdler32;

    property FCheck: byte Read GetFCheck;
  ...
  public
    ...
    property Item: TAbZLItem Read FItem;
...
begin
  ...
  FZLHeader.FLG := FZLHeader.FLG or (AB_ZL_DEFAULT_COMPRESSION shl 6);
  { assume default compression }
  MakeFCheck;
end;
...
begin
  if Value > AB_ZL_CM_MASK then
    Value := (Value shl 4) shr 4;
