object MainFrm: TMainFrm
  ...
  object MainFrm_ButtonsPanel: TPanel
    ...
    object MainFrm_PathBox: TBeeGui_PathBox
      Left = 72
      Top = 71
      Width = 706
      Height = 21
  ...
  object MainFrm_ListView: TBeeGui_ListView
    Left = 0
    Top = 101
    Width = 782
    Height = 425
    ...
    PathBox = MainFrm_PathBox
  end
  object MainFrm_OpenDialog: TOpenDialog
    Filter = 'Bee file (*.bee)|*.bee|Exe file (*.exe)|*.exe|Any file (*.*)|*.*'
  ...
  object MainFrm_DragFilesSrc: TDragFilesSrc
    DropEffect = deMove
    VerifyFiles = False
    OnDropping = MainFrm_DragFilesSrcDropping
    Left = 136
    Top = 136
  end
  object MainFrm_DragFilesTrg: TDragFilesTrg
    Enabled = True
    Target = MainFrm_ListView
    OnDrop = MainFrm_DragFilesTrgDrop
    Left = 104
    Top = 136
  end
end
